...
macro_rules! o(
    ...
    () => {
        OwnedKVGroup(::std::boxed::Box::new(()))
    };
    ($($args:tt)+) => {
        OwnedKVGroup(::std::boxed::Box::new(o!(@ ; $($args)+)))
    };
);
...
macro_rules! o(
    ...
    () => {
        OwnedKVGroup(::alloc::Box::new(()))
    };
    ($($args:tt)+) => {
        OwnedKVGroup(::alloc::Box::new(o!(@ ; $($args)+)))
    };
);
...
macro_rules! slog_o(
    ...
    () => {
        OwnedKVGroup(::alloc::boxed::Box::new(()))
    };
    ($($args:tt)+) => {
        OwnedKVGroup(::alloc::boxed::Box::new(o!(@ ; $($args)+)))
    };
);
