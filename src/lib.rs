...
#[macro_export(local_inner_macros)]
#[cfg_attr(
    not(feature = "suppress-macro2018-warnings"),
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::o!(...) (Rust 2018 feature)"
    )
)]
macro_rules! slog_o(
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::b!(...) (Rust 2018 feature)"
    )
)]
macro_rules! slog_b(
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::kv!(...) (Rust 2018 feature)"
    )
)]
macro_rules! slog_kv(
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::record_static!(...) (Rust 2018 feature)"
    )
)]
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::record!(...) (Rust 2018 feature)"
    )
)]
...
macro_rules! log(
   ...
   (2 @ { $($fmt:tt)* }, { $($kv:tt)* },  $l:expr, $lvl:expr, $tag:expr, $msg_fmt:expr) => {
      $crate::Logger::log(&$l, &record!($lvl, $tag, &$crate::__slog_builtin!(@format_args $msg_fmt, $($fmt)*), b!($($kv)*)))
   };
   (2 @ { $($fmt:tt)* }, { $($kv:tt)* }, $l:expr, $lvl:expr, $tag:expr, $msg_fmt:expr,) => {
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::log!(...) (Rust 2018 feature)"
    )
)]
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::crit!(...) (Rust 2018 feature)"
    )
)]
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::error!(...) (Rust 2018 feature)"
    )
)]
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::warn!(...) (Rust 2018 feature)"
    )
)]
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::info!(...) (Rust 2018 feature)"
    )
)]
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::debug!(...) (Rust 2018 feature)"
    )
)]
...
#[cfg_attr(
    ...
    deprecated(
        since = "2.8.0",
        note = "Use full macro path ::slog::trace!(...) (Rust 2018 feature)"
    )
)]
